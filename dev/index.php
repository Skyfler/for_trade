...
<body>
	...
	?>
	<div class="flex">
		<?php if(!$fgmembersite->CheckLogin()) { require('include/banner.php'); } ?>
		...
		<section class="graphs flex">
			...
			<div class="block">
				<div class="block_inner">
					<a href="https://play.google.com/store/apps/details?id=com.sigfxpro.sf" target="_blank" class="flex">
						<img src="img/apple-iphone6plus-silver-side2.png" class="responsive_img">
					</a>
				</div>
			</div>
		</section>
			...
			<div class="info_blocks_container_inner flex">
				<div class="info_block recomendations flex">
					<div class="info_block_inner">
						<div class="icon sm-visible md-visible lg-visible"><i class="fa fa-line-chart" aria-hidden="true"></i></div>
						<div class="icon xs-visible"><a href="#market_trends_widget"><i class="fa fa-line-chart" aria-hidden="true"></i></a></div>
				...
				<div class="info_block risks flex">
					<div class="info_block_inner">
						<div class="icon sm-visible md-visible lg-visible"><i class="fa fa-star-half-o" aria-hidden="true"></i></div>
						<div class="icon xs-visible"><a href="analytics"><i class="fa fa-star-half-o" aria-hidden="true"></i></a></div>
				...
				<div class="info_block analysis flex">
					<div class="info_block_inner">
						<div class="icon sm-visible md-visible lg-visible"><i class="fa fa-star" aria-hidden="true"></i></div>
						<div class="icon xs-visible"><a href="analytics"><i class="fa fa-star" aria-hidden="true"></i></a></div>
				...
				<div class="info_block trade flex">
					<div class="info_block_inner">
						<div class="icon sm-visible md-visible lg-visible"><i class="fa fa-calendar-check-o" aria-hidden="true"></i></div>
						<div class="icon xs-visible"><a href="calendar"><i class="fa fa-calendar-check-o" aria-hidden="true"></i></a></div>
