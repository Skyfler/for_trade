	...
	<section class="graphs container flex">
		...
		<div class="block">
			<div class="block_inner">
				<iframe id="market_trends_widget" src="https://trading4pro.com/market-trends/?symbols=EURUSD,USDJPY,GBPUSD,XAUUSD,AUDUSD" frameborder="0" height="500" width="306"></iframe>
			</div>
		</div>
		<div class="block">
			<div class="block_inner">
